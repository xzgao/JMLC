function [ z ] = myCompute_eta( K_YY, K_XuXu, K_XuY, lambda1, rho1, tr, gamma, e1, g1 )
% Y: testing data
% X: training data
...
for i1 = 1:MAX_ITER
    ...
    % eta-update
    eta = tr.P*( 2*g1 + rho1*e1 + rho1*z - u1*e1 - u2 );
    ...
    history.objval(i1)  = objective(K_YY, gamma, K_XuXu, eta, K_XuY) + lambda1*norm(z,1);
