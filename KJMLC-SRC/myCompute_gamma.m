function [ z ] = myCompute_gamma( K_YY, K_XuXu, K_XuY, lambda2, rho1, tt, eta, e2, g2 )
...
for i1 = 1:MAX_ITER
    ...
    % gamma-update
    gamma = tt.P*( 2*g2 + rho1*e2 + rho1*z - u3*e2 - u4 );
    ...
    history.objval(i1)  = objective(K_YY, gamma, K_XuXu, eta, K_XuY) + lambda2*norm(z,1);
